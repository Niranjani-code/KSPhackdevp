...
const uri = process.env.MONGODB_URI || 'mongodb+srv://Niranjani:XQcaKaMA7qmmyvoZ@cluster0.xqjmlkh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0';
...
app.listen(8000, () => {
    console.log('Server is running on http://localhost:8000/index.html');
});
